    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="nav-section">
          ...
          <router-link to="/certificates" class="nav-item" :class="{ active: $route.path.startsWith('/certificates') }">
            <svg class="nav-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
            <span class="nav-label">TLS Certificates</span>
          </router-link>
      ...
      <aside v-if="mobileOpen" class="sidebar sidebar-mobile">
        ...
        <nav class="sidebar-nav">
          <div class="nav-section">
            ...
            <router-link to="/certificates" class="nav-item" :class="{ active: $route.path.startsWith('/certificates') }" @click="mobileOpen = false">
              <svg class="nav-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
              <span class="nav-label">TLS Certificates</span>
            ...
            <router-link to="/repositories" class="nav-item" :class="{ active: $route.path.startsWith('/repositories') }"  @click="mobileOpen = false">
            <svg class="nav-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
            </svg>
            <span class="nav-label">Repositories</span>
           ...
           <router-link to="/profile" class="nav-item" :class="{ active: $route.path === '/profile' }" @click="mobileOpen = false">
            ...
            <router-link to="/about" class="nav-item" :class="{ active: $route.path.startsWith('/about') }" @click="mobileOpen = false">
              <svg class="nav-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="10" /><line x1="12" y1="16" x2="12" y2="12" /><line x1="12" y1="8" x2="12.01" y2="8" />
              </svg>
              <span class="nav-label">About</span>
