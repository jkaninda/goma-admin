  ...
  >
    <div class="flex items-center h-14 px-4 border-b border-gray-200 dark:border-gray-700">
      <div class="flex items-center gap-2">
        <img src="/logo.png" alt="Goma" class="w-8 h-8" />
        <span class="text-lg font-semibold text-gray-900 dark:text-white">Goma Admin</span>
      </div>
    </div>
...
const InstancesIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const RoutesIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
  h('path', { 'stroke-linecap': 'round', 'stroke-linejoin': 'round', 'stroke-width': '2', d: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' })
])

const MiddlewaresIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const OAuthIcon = () => h('svg', { class: 'w-5 h-5', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' }, [
...
const adminNavItems = [
  ...
  { to: '/oauth-settings', label: 'OAuth', icon: OAuthIcon },
]
